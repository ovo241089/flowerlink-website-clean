$(document).ready(function () {
    ...
    //Remove Local storage after 12 hours
    var hours = 12;  
...
function cartitem() {
    ...
    for (var i = 0; i < data.length; i++) {
        ...
        html += '<tr>'
            + '<td width="5%" class="plantmore-product-remove"><button class="bg-transparent border-0 text-danger" onclick="removeCartItem(' + data[i].Key + '); return false;"><i class="h3 ion-trash-a mb-0"></i></button></td>'
        if (data[i].Image == "" || data[i].Image == null) {
            html += '<td width="15%" class="plantmore-product-thumbnail"><a href="/Product/ProductDetails?ItemID=' + data[i].ItemID + '"><img class="cart-img" src="/Content/assets/images/NA.png" alt=""></a></td>'
        }
        else {
            html += '<td  width="15%" class="plantmore-product-thumbnail"><a href="/Product/ProductDetails?ItemID=' + data[i].ItemID + '"><img class="cart-img" src="http://admin.flowerlink.net/' + data[i].Image + '" alt=""></a></td>'
        }

        html += '<td width="35%" class="plantmore-product-name">'
        ...
        html += '</td>'
            + '<td width="15%" class="plantmore-product-price"><span class="amount"><span class="currency-text mx-0"></span>' + currency + ' ' + data[i].UPrice.toFixed(2) + '</span></td>'
            + '<td width="15%" class="plantmore-product-quantity">'
            ...
            + '</td>'
            + '<td width="15%" class="product-subtotal">' + currency + ' ' + '<span class="amount totalprice"  id="tprice' + data[i].Key + '">' + ((data[i].Qty * data[i].UPrice) + giftPrice).toFixed(2) + '</span></td>'
            + '</tr>'
    }
