...
namespace WebAPICode.Helpers
{
    public class DBHelper
    {
        ...
        private static readonly string connectionString = "data source=sql5052.site4now.net;initial catalog=DB_A6D23E_flowerlink;user id=DB_A6D23E_flowerlink_admin;password=Tech@963;";
